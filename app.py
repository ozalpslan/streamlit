...
<div style="text-align: center; margin-top: 20px;">
    <img src="https://files.manuscdn.com/user_upload_by_module/session_file/310419663030203251/PuHcdrBwylzGnhcM.png" alt="AWS Certified Cloud Practitioner" style="width: 150px; height: auto; border-radius: 8px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
</div>
""", unsafe_allow_html=True)
